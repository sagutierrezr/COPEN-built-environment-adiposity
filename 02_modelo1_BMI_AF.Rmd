...
# Compara:
#   m_GREEN_cubic1 (solo GREEN_Z * EDU_GROUP)
# vs
#   m_GREEN_cubic2 ((GREEN_Z + GREEN_Z2 + GREEN_Z3) * EDU_GROUP)
#========================================================
...
# Define aquí el orden y etiquetas EXACTAS de EDU_GROUP (como están en tus datos/modelo)
edu_levels <- c("Primaria", "Secundaria o técnico", "Profesional o mayor")

# Interacciones esperadas (depende de tu codificación del factor; normalmente no hay término para la referencia)
b_INTxEDU <- c(
  "EDU_GROUPSecundaria o técnico:INT_Z",
  "EDU_GROUPProfesional o mayor:INT_Z"
)
...
ggplot(plot_df, aes(x = slope, y = y, color = EDU_GROUP)) +
  ...
  # (opcional) si quieres “negrita simulada” para el promedio, deja label vacío y agrega annotate con texto
  annotate("text",
           x = x_label, y = y_prom,
           label = "",
           fontface = "bold", hjust = 0, size = 3.9, color = "grey10") +
